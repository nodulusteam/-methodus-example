...
import { AuthController } from '@example/client';
...
export class LoginComponent {
  ...
  constructor(private ref: ChangeDetectorRef,
    ...
    private userService: UserService, private authService: AuthService, private router: Router, private _ngZone: NgZone) {
  ...
  async tryLogin() {
    const result = await AuthController.token({ Email: this.userName, Password: this.password });
